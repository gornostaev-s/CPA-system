...
Router::route('/clients', [\App\Controller\ClientsController::class, 'index'], AuthMiddleware::class);
...
Router::route('/import-process', [IndexController::class, 'importAll'], AuthMiddleware::class);

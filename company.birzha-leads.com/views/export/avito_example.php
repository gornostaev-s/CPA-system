...
<Ads formatVersion="3" target="Avito.ru">
    ...
    <?php foreach ($items as $item) {
        /**
         * @var \App\Entities\PropertyObject $item
         */
        ?>
        <Ad>
            <Id><?= $item->amoId ?></Id>
            ...
            <ContactMethod>Да</ContactMethod>
    ...
    <Ad>
        ...
        <Description><![CDATA[
            <p>Новая, просторная, <strong>светлая и уютная квартира<strong> с ремонтом и большим холодильником,
    ...
    <Ad>
        ...
        <PropertyRights>Посредник</PropertyRights>
        <RentalType>Прямая</RentalType>
        <ParkingType>Нет</ParkingType>
        <Decoration>Чистовая</Decoration>
        <LeaseCommissionSize>50</LeaseCommissionSize>
    </Ad>
    <Ad>

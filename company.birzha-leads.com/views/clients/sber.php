                                                ...
                                                <?php foreach ($data['companies'] as $company) {
                                                    ...
                                                    <tr class="js-dataRow" data-id="<?= $company->id ?>" style="background-color: <?= CompanyColorHelper::getColorByMode($company->mode) ?>">
                                                        ...
                                                        <?= TableColumnHelper::make()
                                                            ...
                                                            ->setData(!$isAdmin ? ($company->sberbank->comment ?: '') :'<input type="text" name="sberbank[comment]" value="' . $company->sberbank->comment . '" class="table-form__text">')
                                                            ->isHide((!empty($showFields) && !in_array('sberbank[comment]', $showFields)))
                                                            ->build()
                                                        ?>
                                                        <td class="modal-table-primary__col text-left">

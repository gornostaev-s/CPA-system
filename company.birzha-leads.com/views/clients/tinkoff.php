                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <div class="table-responsive js-tableScroll">
                                        <form action="/tinkoff" class="table-form">
                                                ...
                                                <?php foreach ($data['companies'] as $company) {
                                                    ...
                                                    <tr class="js-dataRow" data-id="<?= $company->id ?>" style="background-color: <?= CompanyColorHelper::getColorByMode($company->mode) ?>">
                                                        ...
                                                        <?= TableColumnHelper::make()
                                                            ...
                                                            ->setData(!$isAdmin ? ($company->tinkoff->comment ?: '') :'<input type="text" name="tinkoff[comment]" value="' . $company->tinkoff->comment . '" class="table-form__text">')
                                                            ->isHide((!empty($showFields) && !in_array('tinkoff[comment]', $showFields)))
                                                            ->build()
                                                        ?>
                                                        <td class="modal-table-primary__col text-left">

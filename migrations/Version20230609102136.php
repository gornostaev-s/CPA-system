 ...
 */
final class Version20230609102136 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE leads CHANGE delivered_at delivered_at DATETIME DEFAULT CURRENT_TIMESTAMP');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE leads CHANGE delivered_at delivered_at DATETIME DEFAULT CURRENT_TIMESTAMP NOT NULL');

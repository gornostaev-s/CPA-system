 ...
 */
final class Version20230811132631 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_3AF346688E81BA76 ON categories');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE UNIQUE INDEX UNIQ_3AF346688E81BA76 ON categories (tax)');

 ...
 */
final class Version20230609102511 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE leads CHANGE phone phone BIGINT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE leads CHANGE phone phone INT NOT NULL');

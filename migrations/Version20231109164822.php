 ...
 */
final class Version20231109164822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders CHANGE amount amount NUMERIC(10, 2) DEFAULT \'0\' NOT NULL, CHANGE payment_order_id payment_order_id VARCHAR(255) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE orders CHANGE amount amount NUMERIC(10, 2) DEFAULT \'0.00\' NOT NULL, CHANGE payment_order_id payment_order_id VARCHAR(255) NOT NULL');

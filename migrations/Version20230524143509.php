 ...
 */
final class Version20230524143509 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE flow_subscription ADD rate NUMERIC(10, 2) DEFAULT \'0\' NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE flow_subscription DROP rate');
    }
}
